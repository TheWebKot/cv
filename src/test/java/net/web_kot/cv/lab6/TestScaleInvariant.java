...
import net.web_kot.cv.features.descriptors.impl.HarrisLaplace;
...
public class TestScaleInvariant {
    ...
    private static final List<Triple<String, String, String>> IMAGES = ImmutableList.of(
            ...
            Triple.of("test/cat2.jpg", "test/cat2.jpg", "cat-same"),
    ...
    public static void main(String[] args) {
        for(Triple<String, String, String> test : IMAGES) {
            ...
            TestDescriptors.test("scale", image1, image2, HarrisLaplace::calculate, test.getRight() + "-s", true);
        }
    }
