...
public class Convolution {
    ...
    public static Mat apply(Mat source, Mat kernel) {
        return apply(source, kernel, EdgeWrapMode.DEFAULT);
    }

    public static Mat apply(Mat source, Mat kernel, EdgeWrapMode mode) {
        Mat target = source.withSameSize();
        apply(source, target, kernel, mode);
        return target;
    }

    public static void apply(Mat source, Mat target, Mat kernel) {
        apply(source, target, kernel, EdgeWrapMode.DEFAULT);
    }

    public static void apply(Mat source, Mat target, Mat kernel, EdgeWrapMode mode) {
    ...
    public static Mat apply(Mat source, SeparableKernel kernel) {
        return apply(source, kernel, EdgeWrapMode.DEFAULT);
    }

    public static Mat apply(Mat source, SeparableKernel kernel, EdgeWrapMode mode) {
        Mat target = source.withSameSize();
        apply(source, target, kernel, mode);
        return target;
    }

    public static void apply(Mat source, Mat target, SeparableKernel kernel) {
        apply(source, target, kernel, EdgeWrapMode.DEFAULT);
    }

    public static void apply(Mat source, Mat target, SeparableKernel kernel, EdgeWrapMode mode) {
